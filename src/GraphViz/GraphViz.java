...
public class GraphViz
{
    ...
    public GraphViz() {
    	...
    	this.tempDir = "c:/temp";
        this.executable = "C:/Program Files/graphviz-2.38/release/bin/dot.exe";
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException
    {
        File temp;
        try {
        	temp = new File("fhwsMap.gr");
            //temp = File.createTempFile("graph_", ".gr.tmp", new File(tempDir));
